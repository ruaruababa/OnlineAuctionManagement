...
<main>
    <div class="container">
        <div class="row">
            ...
            <h2 class="heading text-center mt-5 " style="color:green">Thông tin Sản phẩm</h2>
            <div class="col-sm">
                <form action="" method="POST" class="text-center mt-5">
                    <select class="form-control w-25 text-center" id="category" name="category"
                        onchange="nextpage(this)">
                        <option value="manage_user.php">Tất cả</option>
                        <option value="manage_product_mobile.php">Điện thoại</option>
