        ...
        <div class="row">
            <div class="col-sm-6 text-black">
                ...
                <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                    ...
                    <form style="width: 23rem;" id="form2" name="form2" method="post" action="admin_login_code.php">
                        ...
                        <div class="pt-1 mb-4">
                            <button class="btn btn-info btn-lg btn-block" type="submit" name="button" id="button">Login</button>
                        </div>
                        <p>Don't have an account? <a href="Registration-form.php" class="link-info">Register here</a></p>
            ...
            <div class="col-sm-6 px-0 d-none d-sm-block" style="margin-top: 70px;">
